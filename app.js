...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function displayListings(listings, roommates = 1) {
        ...
        listings.forEach(listing => {
            ...
            const verifiedBadge = listing.verified ? '<span class="badge badge-verified me-1">Verified</span>' : '<span class="badge badge-warning me-1">Suspicious</span>';
            ...
            listingCard.innerHTML = `
                <div class="card property-card shadow-sm h-100">
                    <img src="${listing.image}" class="card-img-top" alt="${escapeHtml(listing.title)}" loading="lazy">
